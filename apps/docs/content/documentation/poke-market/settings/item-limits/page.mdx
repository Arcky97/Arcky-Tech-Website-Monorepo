...
<MediaGallery
  items={[
    {
      src: "documentation/poke-market/Item Limit Max Buyable.png",
      alt: "Item Limit Max Buyable",
      width: 770,
      height: 608
    }
  ]}
...
<MediaGallery
  items={[
    {
      src: "documentation/poke-market/Item Limit Out of Stock.png",
      alt: "Item Limit Out of Stock",
      width: 770,
      height: 608
    }
  ]}
...
<MediaGallery
  items={[
    {
      src: "documentation/poke-market/Item Limit Out of Stock Message.png",
      alt: "Item Limit Out of Stock Message",
      width: 770,
      height: 608
    }
  ]}
