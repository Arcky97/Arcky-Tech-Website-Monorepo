...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Quest Icons and Preview 9.png",
      alt: "Quest 6 Stage 1",
      width: 770,
      height: 608
    },
    {
      src: "documentation/region-map/Quest Icons and Preview 10.png",
      alt: "Quest 6 Stage 1 Preview",
      width: 770,
      height: 608
    }
  ]}
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Quest Icons and Preview 11.png",
      alt: "Quest 6 Stage 2",
      width: 770,
      height: 608
    }
