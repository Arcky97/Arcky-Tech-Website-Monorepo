...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Highlight Graphics 1.png",
      width: 619,
      height: 89
    }
  ]}
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Highlight Graphics 2.png",
      alt: "Other folder content",
      width: 681,
      height: 287
    }
  ]}
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Highlight Graphics 3.png",
      alt: "mapSize1x1.png",
      width: 768,
      height: 768
    }
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Highlight Graphics 4.png",
      alt: "Routes folder content",
      width: 646,
      height: 177
    }
  ]}
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Highlight Graphics 5.png",
      alt: "mapRoute1.png",
      width: 511,
      height: 512
    }
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Highlight Graphics 6.png",
      alt: "mapRoute1.png",
      width: 511,
      height: 511
    }
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/Highlight Graphics 7.png",
      alt: "Route 1",
      width: 48,
      height: 48
    },
    {
      src: "documentation/region-map/Highlight Graphics 8.png",
      alt: "Route 1 Highlighted",
      width: 48,
      height: 48
    }
  ]}
