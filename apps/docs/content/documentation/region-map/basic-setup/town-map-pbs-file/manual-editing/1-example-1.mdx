...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/LappetTown-0.png",
      alt: "Lappet Town",
      width: 48,
      height: 48
    }
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/LappetTown-1.png",
      alt: "Lappet Town Highlighted",
      width: 48,
      height: 48
    }
  ]}
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/LappetTown-2.png",
      alt: "Lappet Town Unvisited",
      width: 48,
      height: 48
    }
  ]}
