...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/CedolanCity-0.png",
      alt: "Cedolan City",
      width: 48,
      height: 48
    }
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/CedolanCity-1.png",
      alt: "Cedolan City Highlighted",
      width: 48,
      height: 48
    }
  ]}
...
<MediaGallery
  items={[
    {
      src: "documentation/region-map/CedolanCity-2.png",
      alt: "Cedolan City Unvisited",
      width: 48,
      height: 48
    }
  ]}
