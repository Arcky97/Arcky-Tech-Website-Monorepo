...
2. Inside the Arcky's Region Map folder,  you'll find 2 folders and 2 files <MediaGallery items={[{src: "documentation/region-map/Installation 1.png", alt: "Plugin's Download Folder's Content", width: 632, height: 125 }]} align="left" size="large"/>
