...
<br/>
1. Currently you should see 2 folders and 1 file in the "Arcky's Region Map" folder. 

  <MediaGallery
    items={[
      {
        src: "documentation/region-map/Big Update 1.png",
        width: 709,
        height: 125
      }
    ]}
    size="big"
  />
2. Let's start by opening `000_Settings_and_Setup` folder. 

  <MediaGallery
    items={[
      {
        src: "documentation/region-map/Big Update 2.png",
        width: 712,
        height: 88
      }
    ]}
...
5. Copy these 6 folders and the meta file into the empty "Arcky's Region Map" plugin folder of your project. 

  <MediaGallery
    items={[
      {
        src: "documentation/region-map/Big Update 3.png",
        width: 716,
        height: 246
      }
    ]}
...
- When updating this plugin, always make a back-up of these 2 files.

  <MediaGallery
    items={[
      {
        src: "documentation/region-map/Updating 1.png",
        width: 620,
        height: 60
      }
    ]}
